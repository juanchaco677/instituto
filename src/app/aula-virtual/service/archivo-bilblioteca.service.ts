...
@Injectable()
export class ArchivoBilbliotecaService {
  ...
  getAll(url: string, data: any): Observable<any[]> {
    const params = new HttpParams({ fromString: 'extension=' + data.extension + '&tipo=' + data.tipo + '&id_salon=' + data.id_salon + '&id_programacion=' + data.id_programacion});
