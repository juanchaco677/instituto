...
@Component({
  selector: 'app-asig-profe-asigs',
  templateUrl: './asig-profe-asigs.component.html',
  styleUrls: ['./asig-profe-asigs.component.css']
})
export class AsigProfeAsigsComponent extends ActualizarBaseRedireccionarComponent implements OnInit {
