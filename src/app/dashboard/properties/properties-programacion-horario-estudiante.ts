...
export class PropertiesProgramacionHorarioEstudiante {
  /**
   * r=> ruta
   * f=formulario
   * t=>tabla
  ...
  datos = [
    ...
    },
    {
      ...
      value: ['id' , 'estudiante', 'profesor' , 'materia' , 'salon', 'hora_inicial', 'hora_final']
    },
    {
      key: 'table-eliminar-programacion-horario-estudiante-col',
      value: [ 'select' , 'id' , 'estudiante', 'profesor' , 'materia' , 'salon', 'hora_inicial', 'hora_final']
    },
    {
      key: 'table',
      matColumnDef : ['estudiante', 'profesor' , 'materia' , 'salon', 'hora_inicial', 'hora_final'],
      matHeaderCellDef: ['Estudiante', 'Profesor', 'Materia' , 'Salón', 'Hora Inicial', 'Hora Final'],
    },
    {
